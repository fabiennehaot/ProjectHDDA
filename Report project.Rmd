...
When we plot the two densities of the accepted and rejected kidneys with this model (Figure `r fig_nr`), we see an overlap between the 2 rejection status. This means, that based on this model, the predictions made will not be good. 
