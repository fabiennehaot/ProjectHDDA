...
The standard normal curve is too narrow to fit the distribution (Figure 10A). This can happen when the genes are highly correlated or when the null hypothesis does not hold. The histogram of the p-values (Figure 10B) shows a clear peak for p-values lower than 5%, but there are too many p-values between 5% and 35%. We cannot @BH:1995 now, because this procedure uses the standard normal null distribution to calculate the FDR.
